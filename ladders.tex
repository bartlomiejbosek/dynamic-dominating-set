...
\begin{theorem}
Using $\nearVertexDS{r,n}$ and $\farVertexDS{r,n}$ data
structures,
...
to a query operation on $\farVertexDS{r,n}$ data structure.
...
There exists
$\nearVertexDS{1,n}$ data structure which
...
There exists a randomized data structure $\farVertexDS{1,n}$ that,
...
\begin{corollary}
There exists a fully dynamic algorithm for $1$-dominating set TODO: details.
\end{corollary}
