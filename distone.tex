...
\begin{proof}
	...
	\begin{itemize}
		...
		\item The promised guarantee $T$ on the update/query complexity of $\WeiSum_{f, \wei}[G]$ and $\Ver_{f}[G]$ may depend on $|S|$. The guarantee on the update/query complexity of $\RetVer_{f,\eps}[G]$ becomes $\Oh(T\cdot |S|\cdot \log \tfrac{1}{\eps})$.
	\end{itemize}
